...
public class Controller2 {
    ...
    private final String encabezadoUbi = "SELECT id, edificio, piso, cubiculo ";
    ///////////////Menu Button////////////
   ...
   //De comandos de edicion
    ...
    private void consultaUnicaPor(String campo, String valor, String tableName){
        //editImage.setVisible(false);
        try{
            System.out.println("\nConsultando datos espere por favor...");
            pstmt = myConn.conn.prepareStatement("SELECT id, equipo, nombre, num_inventario, marca, modelo, " +
        ...
        try {
            if(tableView.isVisible()){
                ...
                ObservableList<String> aux = FXCollections.observableArrayList(
                        ...
                        resultset.getString("piso"),
                        resultset.getString("cubiculo"));
                listaValUbi.setItems(aux);
            }
        }catch(NullPointerException | SQLException ne){
            System.out.println("No se ha seleccionado ninguna celda todavía");
        }
