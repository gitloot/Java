...
public class Articulo {
    ...
    public Articulo(int id, String equipo, String nombre, Integer num_inventario, String marca, String modelo,
                              String num_serie, String descripcion, String estado, String final_user, String edificio,
                    String piso, String cubiculo){
        //General
        this.id = id;
    ...
    public Articulo(int id, String equipo){
        //General
        this.id = id;
        this.equipo = new SimpleStringProperty(equipo);
    }
